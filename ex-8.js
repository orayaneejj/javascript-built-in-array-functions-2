...
function eachLocationTotal(bills) {
  let result = bills.reduce(accumulateLocation, {});
  return result;
}
function accumulateLocation(object, bill) {
  if (object[bill.location]) {
    object[bill.location] += bill.total;
  } else {
    object[bill.location] = bill.total;
  }
  return object;
}
const totalPaidByLocation = eachLocationTotal(bills);
